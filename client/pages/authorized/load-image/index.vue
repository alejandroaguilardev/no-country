  ...
  <NuxtLayout name="main-layout" as="main">
    <div class="grid place-items-center py-5 lg:h-[100dvh] lg:h-screen">
      <div class="flex flex-col items-center rounded-lg bg-white p-6 shadow-lg">
        <label
          for="file-upload"
          class="flex h-64 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-6 text-gray-600 hover:bg-gray-100"
        >
          <svg
